...
function eventHandler() {
  ...
  const infoWindows = document.querySelectorAll(".info-window--js");
	...
	const aggressiveApplyButton = document.querySelector('.aggressiveApplyButton');
	...
	aggressiveApplyButton.addEventListener('click', () => {
		Fancybox.close();
		const isAuthed = getCookie('_vkadre');
		if(isAuthed) {
			window.location.href = `${window.location.href}/cabinet/proposal/create`
		} else {
